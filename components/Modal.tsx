        ...
        <MuiModal open={ showModal } onClose={ handleClose } className='fixed !top-7 left-0 right-0 z-50 mx-auto w-full max-w-5xl overflow-hidden overflow-y-scroll rounded-md scrollbar-hide'>
            <>
                ...
                <div className='relative pt-[56.25%]'>
                    <ReactPlayer
                        url={ `https://www.youtube.com/watch?v=${ trailer }` || `https://www.youtube.com/watch?v=4YKpBYo61Cs` }
                        width="100%"
                        height="100%"
                    ...
                    <div className='space-y-6 text-lg'>
                        ...
                        <div className='flex flex-col gap-x-10 gap-y-4 font-light md:flex-row'>
                            ...
                            <div className='flex flex-col space-y-3 text-sm'>
                                ...
                                <div>
                                    <span className='text-[gray] font-semibold'>Original Language: </span>
                                        {movie?.original_language}
                                </div>
                                <div>
                                    <span className='text-[gray] font-semibold'>Total votes: </span>
                                    {movie?.vote_count}
                                </div>
                            </div>
                        </div>
